...
const NumberRangeFilterItem = withLocale(
  ({
    label,
    value,
    onChange,
        ...
        {({ value, onChange }) => (
          <Space.Compact>
            <InputNumber
              ...
              onChange={(target) => {
                onChange(
                  computedFilterValue([target, get(value, 'value[1]')], unit, formatMessage),
                );
              }}
            />
            <Input
            ...
            <InputNumber
              ...
              onChange={(target) => {
                onChange(
                  computedFilterValue([get(value, 'value[0]'), target], unit, formatMessage),
                );
              }}
            />
            {unit && (
