// @ts-nocheck
// Ported from https://github.com/kne-union/info-page/blob/master/src/formatView.js
...
export const defaultFormat = {
  ...
  number: (value, { args }) => {
    const { style, unit, maximumFractionDigits, useGrouping, roundingMode, suffix } = calcArgs(
      args,
      [
        {
          name: 'style',
